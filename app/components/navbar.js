        ...
        <div className="sticky z-10 top-0 shadow-sm shadow-[#1b1b1b] backdrop-blur-3xl">
            <div className="mx-auto lg:w-4/5 my-6 md:flex justify-between items-baseline">
                <div className='flex justify-between items-center'>
                    <Link onClick={navbarOpen && toggleNavbar} href='/' style={{ "fontFamily": "'Rubik Lines', system- ui" }} className="px-4 py-4 cursor-pointer hover:text-neutral-200 text-2xl tracking-wider">sockalingam</Link>
