  ...
  return (
    <div className="px-4 my-16 mx-auto lg:w-4/5">
      ...
      <div className="lg:max-w-2xl flex justify-around lg:justify-between text-lg font-light flex-wrap">
        ...
        <a href="https://github.com/sockalingam29" className="flex items-center hover:text-[#d4d4d4] mx-2 mt-2" target="_blank" rel="noopener noreferrer" >
          <Image src={githubLogo} className="mr-2" width="18" height="18" />
          Github
        </a>

        <a href="https://www.linkedin.com/in/sockalingam29/" className="flex items-center hover:text-[#2966bc] mx-2 mt-2" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.leetcode.com/socka29/" className="flex items-center hover:text-[#e7a41f] mx-2 mt-2" target="_blank" rel="noopener noreferrer">
          <Image src={leetcodeLogo} className="mr-2" width="16" height="16" />
          Leetcode
        </a>

        <a href="https://www.instagram.com/socka_lingam/" className="flex items-center hover:text-[#ee7270] mx-2 mt-2" target="_blank" rel="noopener noreferrer">
